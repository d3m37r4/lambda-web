...
<template>
    ...
    <div class="ml-4 space-y-4">
        <div class="flex items-center space-x-4 mx-4">
            ...
            <div class="flex-none">
                <CreateButton title="button.add" :link="route('dashboard.roles.create')" />
            </div>
        </div>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                            <th>{{ $t('dashboard.page.roles.table.col.role') }}</th>
                            <th>{{ $t('dashboard.page.roles.table.col.created-at') }}</th>
                            <th>{{ $t('dashboard.page.roles.table.col.updated-at') }}</th>
                            <th>{{ $t('dashboard.page.roles.table.col.actions') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="role in roles.data" class="hover:bg-base-300" :class="{ 'bg-base-300': selectedRoles.includes(role.id) }">
                            ...
                            <td>
                                <div class="lg:tooltip" :data-tip="$t('dashboard.table.actions.show-role-permissions')">
