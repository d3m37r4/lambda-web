...
<template>
    ...
    <div class="ml-4 space-y-4">
        <div class="flex items-center space-x-4 mx-4">
            ...
            <div class="flex-none">
                <CreateButton :link="route('dashboard.users.create')" />
            </div>
        </div>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                            <th>{{ $t('dashboard.page.users.table.col.user') }}</th>
                            <th>{{ $t('dashboard.page.users.table.col.role') }}</th>
                            <th>{{ $t('dashboard.page.users.table.col.created-at') }}</th>
                            <th>{{ $t('dashboard.page.users.table.col.actions') }}</th>
                        </tr>
                    </thead>
                    <tbody>
