...
const props = defineProps({
    title: String,
    gameServer: Object,
    punishmentReason: Object,
});

const form = useForm({
    id: props.punishmentReason.id,
    name: props.punishmentReason.name,
    months: props.punishmentReason.months,
    days: props.punishmentReason.days,
    hours: props.punishmentReason.hours,
    minutes: props.punishmentReason.minutes,
});

const update = () => {
    form.put(route('dashboard.game-servers.punishment-reasons.update', [props.gameServer, props.punishmentReason]));
}
</script>
        ...
        <form @submit.prevent="update">
            <div class="bg-base-200 rounded-box p-4">
                <div class="grid grid-cols-6 gap-x-6">
                    ...
                    <div class="col-span-3">
                        <label for="name" class="label">
                            <span class="text-base label-text">{{ ('ID') }}</span>
                        </label>
                        <input
                            id="id"
                            name="id"
