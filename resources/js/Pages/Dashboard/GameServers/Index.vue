...
<template>
    ...
    <div class="ml-4 space-y-4">
        <div class="flex items-center space-x-4 mx-4">
            ...
            <div class="flex-none">
                <CreateButton title="button.add" :link="route('dashboard.game-servers.create')" />
            </div>
        </div>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                            <th>{{ $t('dashboard.page.game-servers.table.col.game-server') }}</th>
                            <th>{{ $t('dashboard.page.game-servers.table.col.online') }}</th>
                            <th>{{ $t('dashboard.page.game-servers.table.col.created-at') }}</th>
                            <th>{{ $t('dashboard.page.game-servers.table.col.updated-at') }}</th>
                            <th>{{ $t('dashboard.page.game-servers.table.col.actions') }}</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="gameServer in gameServers.data" class="hover:bg-base-300" :class="{ 'bg-base-300': selectedItems.includes(gameServer.id) }">
                            ...
                            <td>
                                <div class="lg:tooltip" :data-tip="$t('dashboard.table.actions.show-game-server')">
                                ...
                                <div class="lg:tooltip" :data-tip="$t('dashboard.table.actions.edit')">
                                ...
                                <div class="lg:tooltip" :data-tip="$t('dashboard.table.actions.delete')">
