        ...
        <div class="navbar-content">
            <template v-if="$page.props.auth.user">
                <div class="dropdown">
                    ...
                    <div tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-300 rounded-box w-56">
                        <div class="rounded-lg p-2 drop-shadow-xl divide-y divide-neutral">
                            <div class="flex items-center">
                                <div class="flex mr-auto items-center space-x-2 pb-2">
                                    ...
                                    <div class="space-y-2 flex flex-col flex-1 truncate">
                                        <div class="relative leading-tight text-gray-900">
                                            <span class="flex">
                                                <span class="truncate relative pr-8 text-white">{{ $page.props.auth.user.login }}</span>
                                            </span>
                                        </div>
                                        <div class="badge badge-secondary rounded leading-tight">{{ $page.props.auth.user.role_name }}</div>
                                    </div>
                                </div>
                            </div>
                            <div class="py-2">
                                <nav class="grid gap-1">
                                    <Link :href="route('admin.index')" class="flex items-center leading-6 space-x-3 w-full text-gray-500 focus:outline-none hover:bg-gray-100 rounded-md">
                                    ...
                                    <a href="/" class="flex items-center leading-6 space-x-3 w-full text-gray-500 focus:outline-none hover:bg-gray-100 rounded-md">
                            ...
                            <div class="pt-2">
                                <Link :href="route('logout')" method="post" class="flex items-center space-x-3 w-full leading-6 text-gray-500 focus:outline-none hover:bg-gray-100 rounded-md">
                                    <svg class="w-5 h-5" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
