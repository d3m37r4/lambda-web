...
@section('title', 'Добавление ключа доступа')
        ...
        <div class="card-body">
            <form action="{{ route('admin.servers.accesses.store', $server) }}" method="POST">
                ...
                <div class="row form-group mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="description" type="text" class="form-control @error('description') is-invalid @enderror"
                               ...
                               placeholder="{{ 'Добавьте описание для доступа' }}" required>
                ...
                <div class="d-flex justify-content-center mt-4">
                    @include('admin.components.btn-add', ['title' => 'Добавить доступ'])
                </div>
            </form>
        </div>
    </div>
